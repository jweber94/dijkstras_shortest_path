...
double ConfigLoader::get_lower_edge_weight() const {
    return this->lower_; 
}

double ConfigLoader::get_upper_edge_weight() const {
    return this->upper_; 
}

double ConfigLoader::get_edge_prob() const {
    return this->edge_prob_; 
}

size_t ConfigLoader::get_num_nodes() const {
